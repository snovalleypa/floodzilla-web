...
var undeleteIdList;
function InitAdminDelUndelWithReason(deleteIdListName, undeleteIdListName) {
    ...
    $("#DelConfirmModel").on('shown.bs.modal', function () {
        $(".admin-del-reason").focus();
    });
    ...
    $("#UndelConfirmModel").on('shown.bs.modal', function () {
        $(".admin-undel-reason").focus();
    });
